		...
		<article>
			<section>
				...
				<p>
					...
					obsesionado con encontrar la pasión de mi vida y en este blog encontrarás todas las cosas
					que descubrí y que me ayudaron a encontrar la pasión de mi vida.
				</p>
				<p>
			...
			<section>
				...
				<p>Existen diferentes maneras para encontrar la pasión de tu vida o acelerar el proceso.</p>
				<blockquote>
				...
				<ol>
					...
					<li>
						...
						<strong>Piensa en tus sueños:</strong> Ahora tienes que escribir todas las cosas con las
						que alguna vez soñaste, o siempre soñaste hacer, pero no hiciste por falta de tiempo,
						dinero, porque te atemorizaba, porque no les veías la finalidad o por cualquier otra
						razón.
						<ul>
						...
						<p>
							Tómate el tiempo que necesites para responderlas, y de igual manera es muy importante
							que seas sincero.
						</p>
					</li>
					<li>
			...
			<section>
				...
				<ul>
					...
					<li>
						<strong>Experimenta:</strong> No existe una fórmula general para encontrar la pasión de
						tu vida, cada persona es única y lo importante es que pruebes diferentes opciones y
					...
					<li>
						...
						estratégica. Lo mejor es recurrir a trazarte un propósito o meta 100% medible,
						...
						alcanzar tus metas, además tendrás más tiempo y espacio de reflexión y conexión para
			...
			<section>
				...
				<blockquote>
					La pasión es algo demasiado importante como para no tenerla, pero demasiado inconsistente
					como para estar constantemente persiguiéndola. (No persigas tu pasión, siempre llévala
				...
				<ol>
					<li>
						<strong>No persigas tu pasión, SIEMPRE llévala contigo, en todo lo que haces.</strong>
					</li>
					<li>
						...
						aprendizaje", disfruta ese proceso de aprender y comparte tu conocimiento con los demás.
			...
			<section>
				...
				<p>
					En este blog vimos muchos temas, por eso intentaré hacer sólo una breve conclusión de lo
					que vimos.
				</p>
				<p>
					Para poder encontrar tu pasión (Si en realidad es lo que quieres) debes de tener el
					autoconocimiento suficiente y experimentar.
				</p>
				<p>
					Si todavía no tienes muy en claro qué es lo que te gusta, debes de salir de tu zona de
					confort, debes de experimentar y probar cosas nuevas.
				</p>
				<p>
					Lo último, la pasión es tu motor, no es algo que quieras encontrar, no te obsesiones por
					encontrar o descubrir tu pasión, si es cierto que existen preguntas que te pueden ayudar y
					encontrar lo que te gusta, pero la pasión tienes que vivirla, la pasión la debes de llevar
